...
/******/ 	return __webpack_require__(__webpack_require__.s = "b0d2");
/******/ })
/************************************************************************/
/******/ ({
...
// EXTERNAL MODULE: ./components/SingleRecipe.js
var SingleRecipe = __webpack_require__("2a+D");
...
// CONCATENATED MODULE: ./components/UpdateRecipe.js
...
var UPDATE_RECIPE_MUTATION = external_graphql_tag_default()(_templateObject());

var UpdateRecipe_UpdateRecipe =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(UpdateRecipe, _Component);
  ...
  function UpdateRecipe() {
    ...
    Object(classCallCheck["a" /* default */])(this, UpdateRecipe);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(UpdateRecipe)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "updateRecipe",
    /*#__PURE__*/
    function () {
      var _ref = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(e, updateRecipeMutation) {
        var res;
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "uploadFile",
    /*#__PURE__*/
    function () {
  ...
  Object(createClass["a" /* default */])(UpdateRecipe, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        query: SingleRecipe["a" /* SINGLE_RECIPE_QUERY */],
        variables: {
          id: this.props.id
        }
      }, function (_ref3) {
        ...
        if (error) return external_react_default.a.createElement("p", null, external_react_default.a.createElement(ErrorMessage["a" /* default */], {
          error: error
        }));
        if (!data.recipe) return external_react_default.a.createElement("p", null, "No recipe found...");
        return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
          ...
          return external_react_default.a.createElement(Form["a" /* default */], {
            ...
            htmlFor: "ingredients"
          }, "Ingredients", external_react_default.a.createElement("input", {
            type: "text",
            id: "ingredients",
            name: "ingredients",
          ...
          }, "Instructions", external_react_default.a.createElement("textarea", {
            id: "instructions",
            name: "instructions",
            ...
            type: "sumbit"
          }, "Update"), external_react_default.a.createElement("button", null, "Back"));
        });
      });
    }
  }]);
...
/* harmony default export */ var components_UpdateRecipe = (UpdateRecipe_UpdateRecipe);
...
var update_EditRecipe = function EditRecipe(_ref) {
  var query = _ref.query;
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignin["a" /* default */], null, external_react_default.a.createElement(components_UpdateRecipe, {
    id: query.id
  })));
};

/* harmony default export */ var update = __webpack_exports__["default"] = (update_EditRecipe);
